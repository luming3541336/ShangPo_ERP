Public Class Set_ReceiptKey_Model
    ...
    Protected Const INSERT_RECEIPTKEY_SQL = "INSERT INTO ReceiptKey(ReceiptID,Room,Item,Location,ReceiptCount,Remark) VALUES(N'@id',N'@room',N'@item',N'@locaion',@count,N'@remark');SELECT @@IDENTITY as id"
